...
const sendEmail = (e) =>{
    ...
    if(contactName.value===''||contactEmail.value===''||contactProject.value===''){
        ...
        // Prepare form data with current time
        const formData = {
            user_name: contactName.value,
            user_email: contactEmail.value,
            user_project: contactProject.value,
            current_time: new Date().toLocaleString() // send time
        }; 
        // serviceID - templateID - #form - publicKey
        // 'service_4nf09a2','template_mfd9yxg','#contact-form','ogP8kVSh6qP6hSNhS' --aditya
        emailjs.send('service_4om5w44','template_2bziews', formData ,'Rtr33mD8HP5I5BkxD')
            .then(() =>{
